...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class MlkitLibraryAccessors extends SubDependencyFactory {
        private final MlkitSegmentationLibraryAccessors laccForMlkitSegmentationLibraryAccessors = new MlkitSegmentationLibraryAccessors(owner);

        public MlkitLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>mlkit.segmentation</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public MlkitSegmentationLibraryAccessors getSegmentation() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForMlkitSegmentationLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class MlkitSegmentationLibraryAccessors extends SubDependencyFactory {

        public MlkitSegmentationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>subject</b> with <b>com.google.mlkit:segmentation-subject</b> coordinates and
         * with version reference <b>mlkitSubject</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getSubject() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("mlkit.segmentation.subject");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>mlkitSubject</b> with value <b>16.0.0-beta1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMlkitSubject() { return getVersion("mlkitSubject"); }
