...
public final class ActivitySurveyDupBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySurveyDupBinding(@NonNull ConstraintLayout rootView, @NonNull FrameLayout frAds,
  ...
  @NonNull
  public static ActivitySurveyDupBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySurveyDupBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_survey_dup, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySurveyDupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySurveyDupBinding((ConstraintLayout) rootView, frAds, llTitle,
