...
public final class DialogProgressBinding implements ViewBinding {
  ...
  private DialogProgressBinding(@NonNull LinearLayout rootView, @NonNull TextView progressMessage) {
  ...
  public static DialogProgressBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogProgressBinding((LinearLayout) rootView, progressMessage);
    }
