...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `favorites` (`wallpaperId` TEXT NOT NULL, `addedAt` INTEGER NOT NULL, PRIMARY KEY(`wallpaperId`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS `recents` (`wallpaperId` TEXT NOT NULL, `viewedAt` INTEGER NOT NULL, PRIMARY KEY(`wallpaperId`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '3d48ff7e192fdd6e1be26818a7aa6fcd')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoFavorites.equals(_existingFavorites)) {
          return new RoomOpenHelper.ValidationResult(false, "favorites(com.galaxywall.app.data.local.FavoriteEntity).\n"
                  + " Expected:\n" + _infoFavorites + "\n"
                  + " Found:\n" + _existingFavorites);
        }
        final HashMap<String, TableInfo.Column> _columnsRecents = new HashMap<String, TableInfo.Column>(2);
        _columnsRecents.put("wallpaperId", new TableInfo.Column("wallpaperId", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsRecents.put("viewedAt", new TableInfo.Column("viewedAt", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final TableInfo _existingRecents = TableInfo.read(db, "recents");
        if (!_infoRecents.equals(_existingRecents)) {
          return new RoomOpenHelper.ValidationResult(false, "recents(com.galaxywall.app.data.local.RecentEntity).\n"
                  + " Expected:\n" + _infoRecents + "\n"
                  + " Found:\n" + _existingRecents);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "3d48ff7e192fdd6e1be26818a7aa6fcd", "dbab94ac5d513895a6e7bad84c170e25");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "favorites","recents");
  }
