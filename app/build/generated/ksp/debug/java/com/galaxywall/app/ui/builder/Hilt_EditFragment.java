...
public abstract class Hilt_EditFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditFragment_GeneratedInjector) this.generatedComponent()).injectEditFragment(UnsafeCasts.<EditFragment>unsafeCast(this));
    }
  }
