...
public abstract class Hilt_OverlayFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OverlayFragment() {
    super();
  }

  Hilt_OverlayFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OverlayFragment_GeneratedInjector) this.generatedComponent()).injectOverlayFragment(UnsafeCasts.<OverlayFragment>unsafeCast(this));
    }
  }
