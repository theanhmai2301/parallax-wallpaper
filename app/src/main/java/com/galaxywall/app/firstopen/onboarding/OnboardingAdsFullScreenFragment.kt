...
/**
 * Full-screen native-ad onboarding page (placeholder). Mirrors the source app's
 * OnboardingAdsFullScreenFragment: it only hosts a full-screen native ad + a Next/close control that
 * advances the pager. The ad itself is left as the [loadFullScreenAd] hook (frAds is the container).
 */
class OnboardingAdsFullScreenFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(page: Int): OnboardingAdsFullScreenFragment =
            OnboardingAdsFullScreenFragment().apply {
